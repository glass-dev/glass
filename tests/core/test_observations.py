...
def test_vmap_galactic_ecliptic(xp: ModuleType) -> None:
    ...
    xp_assert_equal(vmap, xp.zeros_like(vmap))
...
def test_gaussian_nz(
    ...
    xp_assert_equal(nz, xp.zeros_like(nz))
...
def test_smail_nz(xp: ModuleType) -> None:
    ...
    xp_assert_equal(pz, xp.zeros_like(pz))
...
def test_tomo_nz_gausserr(xp: ModuleType) -> None:
    ...
    xp_assert_equal(binned_nz, xp.zeros_like(binned_nz))
