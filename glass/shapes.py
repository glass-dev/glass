...
def triaxial_axis_ratio(
    ...
    xi: float | FloatArray,
    size: int | tuple[int, ...] | MISSING = MISSING,
    *,
...
def resample_shapes(
    ...
    *,
    varg: float | MISSING = MISSING,
    vargamma: float | MISSING = MISSING,
    rng: UnifiedGenerator | MISSING = MISSING,
) -> ComplexArray:
    ...
    """
    if varg is not MISSING and vargamma is not MISSING:
