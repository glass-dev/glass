...
class Normal:
    ...
    def __call__(
        self, x: NDArray[Any] | AArray, _var: float, /
    ) -> NDArray[Any] | AArray:
        """Return *x* unchanged."""
        return x
...
class Lognormal:
    ...
    def __call__(
        self, x: NDArray[Any] | AArray, var: float, /
    ) -> NDArray[Any] | AArray:
...
@corr.add
def _(
    t1: Lognormal, t2: Lognormal, x: NDArray[Any] | AArray, /
) -> NDArray[Any] | AArray:
    xp = x.__array_namespace__()
...
@corr.add
def _(
    t1: SquaredNormal, t2: SquaredNormal, x: NDArray[Any] | AArray, /
) -> NDArray[Any] | AArray:
    aa = t1.a * t2.a
