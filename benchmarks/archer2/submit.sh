...
do
    ...
    HEALPY_DATAPATH="$HEALPY_DATAPATH" ARRAY_BACKEND="$ARRAY_BACKEND" srun --hint=nomultithread --distribution=block:block "$GLASS_DIR/.venv/bin/python" "$GLASS_DIR/benchmarks/lensing.py"
done
